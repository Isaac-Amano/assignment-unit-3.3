...
console.log("Supply Changes after adding 25:", supplyChanges);
...
// Log the arrays to ensure they are correct
console.log("Stretch Positives:", stretchPositives); // Should log: [3, 5, 7, 25]
console.log("Stretch Negatives:", stretchNegatives); // Should log: [-6]
console.log("Stretch Zeroes:", stretchZeroes);       // Should log: [0]
